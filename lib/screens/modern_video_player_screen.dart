...
//     final vpc = _bp?.videoPlayerController;
//     final current = vpc?.value.position;
//     if (current == null) return;
//     var target = current + delta;
//     if (target < Duration.zero) target = Duration.zero;
//     await _bp?.seekTo(target);
//   }
//
...
//
//     try {
//       print('Switching to channel: ${channel.url}');
//       print('Custom headers: ${_getCustomHeaders()}');
...
//       );
//       if (_bp == null) {
//         _bp = BetterPlayerController(const BetterPlayerConfiguration(autoPlay: true, fit: BoxFit.contain));
//       }
//       await _bp!.setupDataSource(ds);
//       await _bp!.play();
//       setState(() {});
//       _scheduleAutoHide();
//     } catch (e) {
...
//         ),
//       );
//       final isDash = widget.url.toLowerCase().endsWith('.mpd');
//       final ds = BetterPlayerDataSource(
//         isDash ? BetterPlayerDataSourceType.dash : BetterPlayerDataSourceType.network,
//         widget.url,
//         headers: _getCustomHeaders(),
//         useHlsSubtitles: true,
//         useHlsTracks: true,
//       );
//       _bp = BetterPlayerController(config);
//       await _bp!.setupDataSource(ds);
//       await _bp!.play();
//       if (mounted) setState(() {});
//     } catch (e) {
...
//                             )
//                           : AspectRatio(
//                               aspectRatio: _bp!.value.aspectRatio == 0
//                                   ? 16 / 9
//                                   : _bp!.value.aspectRatio,
//                               child: LayoutBuilder(
...
//                                                   fit: BoxFit.cover,
//                                                   child: SizedBox(
//                                                     width: _bp!.value.size.width,
//                                                     height: _bp!.value.size.height,
//                                                     child: BetterPlayer(
//                                                       controller: _bp!,
//                                                     ),
//                                                   ),
...
//                                                         // Play/Pause button
//                                                         _ModernControlButton(
//                                                           icon: _bp!.value.isPlaying
//                                                               ? Icons.pause_circle_filled
//                                                               : Icons.play_circle_filled,
//                                                           size: 80,
//                                                           onTap: () async {
//                                                             if (_bp!.value.isPlaying) {
//                                                               await _bp!.pause();
//                                                             } else {
//                                                               await _bp!.play();
//                                                             }
...
//                                                           children: [
//                                                             Text(
//                                                               _formatDuration(_bp!.value.position),
//                                                               style: const TextStyle(
//                                                                 color: Colors.white,
//                                                                 fontSize: 14,
//                                                               ),
//                                                             ),
//                                                             Text(
//                                                               _formatDuration(_bp!.value.duration),
//                                                               style: const TextStyle(
//                                                                 color: Colors.white,
//                                                                 fontSize: 14,
//                                                               ),
